...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _2981285_archive_1.so
_2981285_archive_1.so : archive.18/_2981285_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -z notext -m elf_i386  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../sim.daidir//_2981285_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../sim.daidir//_2981285_archive_1.so $@
