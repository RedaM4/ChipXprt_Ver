...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _168898_archive_1.so
_168898_archive_1.so : archive.5/_168898_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -z notext -m elf_i386  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_168898_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_168898_archive_1.so $@
