...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _2033568_archive_1.so
_2033568_archive_1.so : archive.58/_2033568_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -z notext -m elf_i386  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../sim.daidir//_2033568_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../sim.daidir//_2033568_archive_1.so $@
