...
extern "C" {
#endif
void  rmaPropagate0_sim_mem_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_sim_mem_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_sim_mem_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_sim_mem_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_sim_mem_daidir (UB  * pcode, scalar  val);
